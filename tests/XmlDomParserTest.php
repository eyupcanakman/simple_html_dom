...
use eyupcanakman\SimpleHtmlDom\XmlDomParser;
...
final class XmlDomParserTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testXMLWithoutLoadingDtd()
    {
        ...
        $xmlParser = new \eyupcanakman\SimpleHtmlDom\XmlDomParser();
  ...
  <Message>
    ...
    public function testXmlFind()
    {
        ...
        $xmlParser->setCallbackBeforeCreateDom(
            static function (string $str, \eyupcanakman\SimpleHtmlDom\XmlDomParser $xmlParser) {
                return \str_replace('array', 'arrayy', $str);
            }
        );
        $xmlParser->setCallbackXPathBeforeQuery(
            static function (string $cssSelectorString, string $xPathString, \DOMXPath $xPath, \eyupcanakman\SimpleHtmlDom\XmlDomParser $xmlParser) {
    ...
    {
        $dom = (new eyupcanakman\SimpleHtmlDom\XmlDomParser())->loadHtml('<Foo> foo bar </Foo>');
        static::assertSame(' foo bar ', $dom->findOne('Foo')->innerXml());
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleXmlDomBlank::class, $dom->findOne('Bar'));
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleXmlDomBlank::class, $dom->findOne('Bar')->findOne('Bar'));
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleXmlDomBlank::class, $dom->findOne('Bar')->findOne('Bar')->findOne('Bar'));
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleXmlDomBlank::class, $dom->findOne('Bar')->findOne('Bar')->findOne('Bar')->findOne('Bar'));
    }
