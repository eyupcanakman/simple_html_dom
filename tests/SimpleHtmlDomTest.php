...
final class SimpleHtmlDomTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $dom = (new eyupcanakman\SimpleHtmlDom\HtmlDomParser())->loadHtml('<div> foo bar </div>');
        static::assertSame('foo bar', $dom->findOne('div')->innerHtml());
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleHtmlDomBlank::class, $dom->findOne('span'));
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleHtmlDomBlank::class, $dom->findOne('span')->findOne('span'));
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleHtmlDomBlank::class, $dom->findOne('span')->findOne('span')->findOne('span'));
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleHtmlDomBlank::class, $dom->findOne('span')->findOne('span')->findOne('span')->findOne('span'));
    }
...
';
    ...
    public function testGetDom()
    {
        ...
        static::assertInstanceOf(eyupcanakman\SimpleHtmlDom\HtmlDomParser::class, $element->getHtmlDomParser());
    }
    ...
    public function testFind($html, $selector, $count)
    {
        ...
        foreach ($elements as $node) {
            static::assertInstanceOf(eyupcanakman\SimpleHtmlDom\SimpleHtmlDomInterface::class, $node);
        }
    ...
    public function testGetElementsByTagName()
    {
        ...
        static::assertInstanceOf(\eyupcanakman\SimpleHtmlDom\SimpleHtmlDomNode::class, $elements);
    ...
    public function testChildNodes()
    {
        ...
        static::assertInstanceOf(eyupcanakman\SimpleHtmlDom\SimpleHtmlDomNode::class, $nodes);
    ...
    public function testNextSibling()
    {
        ...
        static::assertInstanceOf(eyupcanakman\SimpleHtmlDom\SimpleHtmlDom::class, $sibling);
